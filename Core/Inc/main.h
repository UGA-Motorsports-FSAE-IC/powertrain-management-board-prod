...
typedef struct {
  rxmessage messagequeue[CAN_QUEUE_SIZE];
...
#define throttlerelay_Pin GPIO_PIN_1
#define throttlerelay_GPIO_Port GPIOA
#define upshift_Pin GPIO_PIN_6
#define upshift_GPIO_Port GPIOA
#define downshift_Pin GPIO_PIN_7
#define downshift_GPIO_Port GPIOA
